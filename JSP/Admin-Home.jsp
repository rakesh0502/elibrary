...
<table width="100%">
<tr>
<td align="left" class="headerLink"><spring:message code="label.welcome_admin"/></td>
<td align="right" class="headerLink"><a href="addDoc.elib"><spring:message code="label.add_document"/></a> | <a href="logout.elib"><spring:message code="label.logout"/></a></td>
</tr>
</table>
</td>
</tr>
...
<form:form name="frm" method="post" modelAttribute="doc" action="sample.elib?page=&reqPage=Admin-Home">
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
...
<tr>
<td align="center" class="thanksText" colspan="2"><spring:message  code="${msgResult}"></spring:message></td></tr></c:if>
<tr>
...
<tr><td>${recordno}&nbsp;&nbsp;<spring:message  code="${message}"/></td></tr></form:form>
...
<td>${docs.author}</td>
<td>${docs.price}</td>
<td><a href="showEditPage.elib?docId=${docs.docId}"><img src="images/Modify.jpg" class="noBorder" alt="modify"/></a><input type="hidden" name="docId" value="${docs.docId}"></td>
</tr>
</c:forEach>
</table>
...
<th class="headerLink"><a href="pagination.elib?page=${currentPage - 1}&reqPage=Admin-Home">Previous</a></th>
</c:if>
...
<c:otherwise>
<th ><a href="pagination.elib?page=${i}&reqPage=Admin-Home">${i}</a></th>
</c:otherwise>
</c:choose>
</c:forEach>
...
<th class="headerLink"><a href="pagination.elib?page=${currentPage + 1}&reqPage=Admin-Home">Next</a></th>
</c:if>
</tr>
</table>
