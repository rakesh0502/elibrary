...
<td align="right" class="headerLink"><a href="showHome.elib"><spring:message code="label.home"/></a></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td align="center" class="thanksText" colspan="2"><spring:message code="message.msg"/></td>
</tr>
<tr>
<td align="right" class="moduleText" style="width:50%"><spring:message code="label.documentId"/></td>
<td align="left" style="width:50%"><span class="moduleText" id="documentID">${docID}</span><input type="hidden" name="docId" value="${docID}"></td>
</tr>
<tr>
...
<tr>
<td  align="right" class="moduleText"><spring:message code="label.documentType"/></td>
