...
{
	var ch=true;
	var cvv=document.subpayment.txtCvvNumber.value;
	var creditnofirst=document.subpayment.txtFirstSet.value;
	var txtSecondSet=document.subpayment.txtSecondSet.value;
	var txtThirdSet=document.subpayment.txtThirdSet.value;
	var txtFourthSet=document.subpayment.txtFourthSet.value;
...
<div id="paymentArea">
<form name="subpayment" id = "subpayment" action="successpayment.elib">
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
...
<td align="left" style="width:60%">Rs-${price}(After 20% Discount)</td><td><input type="hidden" name="price" value="${price}"></td><td><input type="hidden" name="docId" value="${docId}"></td>
</tr>
<tr>
...
<td align="left">
<input id="txtFirstSet" name="txtFirstSet" type="text" size="3" maxlength="4"/>-<input id="txtSecondSet" name="txtSecondSet" type="text" size="3" maxlength="4"/>-<input id="txtThirdSet" name="txtThirdSet" type="text" size="3" maxlength="4"/>-<input id="txtFourthSet" type="text" name="txtFourthSet" size="3" maxlength="4"/>
</td>
</tr>
<tr>
...
<td align="left" ><input id="txtCvvNumber" type="password" size="2" maxlength="3"/></td>
</tr>
<tr>
<!--<td align="right"><input style="background: url('images/Buy.jpg');" type="submit" name="buy" onclick="return checkfirst()"></td>-->

<td align="right"><img src="images/Buy.jpg" onclick="return checkfirst()" class="noBorder" alt="Buy" style="cursor:hand"/></td>
