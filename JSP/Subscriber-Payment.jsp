...
<title>E-Library Management ::Payment Gateway</title>
...
<td align="left" style="width:60%"><spring:message code="label.subamount"/></td>
</tr>
<tr>
...
<td align="left" ><input id="txtCvvNumber" name="txtCvvNumber" type="password" size="2" maxlength="3"/></td>
</tr>
<tr>
<td align="right"><a href="show2.elib?userId=<%=session.getAttribute("userId")%>" onclick="return checkfirst()"><img src="images/Buy.jpg" class="noBorder" alt="Buy"/></a></td>
<td align="left"><a href="show1.elib"><img src="images/Cancel.jpg" class="noBorder" alt="Cancel"/></a></td>
</tr>
</table>
</td>
</tr>
